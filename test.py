...
except NegativeDepositException:
    print("You cant deposit 0 or low than 1")
except NegativeWithdrawalError:
    print("You cant withdraw 0 or low than 1")
except InsufficientFundsError:
    print("You cant withdraw an amount that you dont have on your balance")
